...
# Look for RISC-V 
FIND_FILE( RISCV_CENTOS_GCC_COMPILER "riscv64-unknown-elf-gcc" PATHS /opt/riscv64-unknown-elf-gcc-20171231-x86_64-linux-centos6/bin/ ENV INCLUDE)

# Look for RISC-V toolchain built by CT-NG
FIND_FILE( RISCV_CTNG_GCC_COMPILER "riscv32-unknown-elf-gcc" PATHS /home/vexriscv/x179/riscv32-unknown-elf/bin ENV INCLUDE)

message(" Found: ${RISCV_CENTOS_GCC_COMPILER}")

# Select which is found, priority ordered
if (EXISTS ${RISCV_CTNG_GCC_COMPILER})
set( RISCV_GCC_COMPILER ${RISCV_CTNG_GCC_COMPILER})
elseif (EXISTS ${RISCV_XPACK_NEW_GCC_COMPILER})
...
#elseif (EXISTS ${RISCV_CENTOS_GCC_COMPILER})
#set( RISCV_GCC_COMPILER ${RISCV_CENTOS_GCC_COMPILER})
else()
...
STRING(REGEX REPLACE "\-gcc$" "-" CROSS_COMPILE ${RISCV_TOOLCHAIN_BIN_PATH}/${RISCV_TOOLCHAIN_BIN_GCC})
message( "RISC-V Cross Compile: ${CROSS_COMPILE}" )

# The Generic system name is used for embedded targets (targets without OS) in
# CMake
set( CMAKE_SYSTEM_NAME          Generic )
set( CMAKE_SYSTEM_PROCESSOR     rv32i_zicsr )
...
set( CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS}  -march=${CMAKE_SYSTEM_PROCESSOR} -mabi=${CMAKE_SYSTEM_ABI}")
#   